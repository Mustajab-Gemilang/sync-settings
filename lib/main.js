		...
		setImmediate(() => {
			try {
				...
				this.disposables.add(
					atom.commands.add('atom-workspace', 'sync-settings-fork:check-backup', () => this.syncSettings.checkBackup()),
					atom.commands.add('atom-workspace', 'sync-settings-fork:create-backup', () => this.syncSettings.createBackup()),
					atom.commands.add('atom-workspace', 'sync-settings-fork:fork', () => this.syncSettings.fork()),
					atom.commands.add('atom-workspace', 'sync-settings-fork:delete-backup', () => this.syncSettings.deleteBackup()),
					atom.commands.add('atom-workspace', 'sync-settings-fork:backup', () => this.syncSettings.backup()),
					atom.commands.add('atom-workspace', 'sync-settings-fork:restore', () => this.syncSettings.restore()),
					atom.commands.add('atom-workspace', 'sync-settings-fork:view-backup', () => this.syncSettings.viewBackup()),
					atom.commands.add('atom-workspace', 'sync-settings-fork:view-diff', () => this.syncSettings.viewDiff()),
				)
				resolveActivation()
			} catch (err) {
